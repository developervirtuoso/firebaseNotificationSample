                        ...
                        <li id="home">
                         ...
                         <li id="languages">
                          <!--   <a href="#"  id="languages1">Super Admin</a> -->
                                 ...
                                 <li id="languagesList">
                                    <a href="#" id="languagesList2">Firebase Notifications</a>
                                    <ul class="nav nav-second-level">
			                                <li id="languagesList">
                                    			<a href="admin-notifications.jsp?clr=languagesList5&act=languagesList5" id="languagesList58">Send Notifications</a>
			                                </li>
			                                 <li id="languagesList">
                                    			<a href="view_sent_notifs.jsp?clr=languagesList5&act=languagesList5" id="languagesList59">View sent notifications</a>
			                                </li>
			                                </ul></li>
