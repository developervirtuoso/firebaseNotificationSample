...
<div class="container">
    ...
    %> 
                        ...
                        <form role="form" action="userRegister" method="post" onsubmit="return siteAdminSignIn()" name="frm">
                            <fieldset>
                            <div class="form-group">
          <input type="text" id="name" class="form-control" placeholder="Enter your Name" name="name" autofocus>
        </div>
        <span id="nameloc" style="color: red; font-size: 13px"></span>
